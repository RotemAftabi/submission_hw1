...
- Location: C:\Users\Rotem Aftabi\submission_hw1\frontend\playwright-tests\test.spec.ts:16:1
...
Call log:
  - waiting for locator('button[name="add_new_note"]')
    ...
    at C:\Users\Rotem Aftabi\submission_hw1\frontend\playwright-tests\test.spec.ts:17:14
```
