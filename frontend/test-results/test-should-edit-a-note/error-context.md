...
- Location: C:\Users\Study\Desktop\semester F\תכנות קצה\submission_hw3\frontend\playwright-tests\test.spec.ts:60:1
...
Received string: "You must be logged in"
Call log:
  - expect.toHaveText with timeout 5000ms
  - waiting for locator('.notification')
    9 × locator resolved to <div class="notification">You must be logged in</div>
      - unexpected value "You must be logged in"

    at C:\Users\Study\Desktop\semester F\תכנות קצה\submission_hw3\frontend\playwright-tests\test.spec.ts:69:47
```
