...
- Location: C:\Users\Rotem Aftabi\submission_hw1\frontend\playwright-tests\test.spec.ts:36:1
...
Call log:
  - waiting for locator('button[data-testid="delete-${noteId}"]')

    at C:\Users\Rotem Aftabi\submission_hw1\frontend\playwright-tests\test.spec.ts:39:14
```
